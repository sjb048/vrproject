 ...
 */
void SeasonalEffect::initialize(Season initialSeason) {
 ...
 */
void SeasonalEffect::render(const glm::mat4& view, const glm::mat4& projection) {
